...
function Configure-NiFi {
    ...
    $settings = [ordered]@{
        ...
        'nifi.web.proxy.host'                          = 'localhost:8443,127.0.0.1:8443'
    ...
    # NiFi generates first-run single-user credentials and records them in nifi-app.log.
    # Do not call nifi.cmd set-single-user-credentials here: the 2.10.0 Windows
    # launcher drops those arguments inside its batch block.
}
