...
This directory contains superseded artifacts retained for provenance:

- [`stage1-preprocessing-prototype/`](stage1-preprocessing-prototype/) is the earlier YARRRML workflow that enriched and flattened the source before mapping.
