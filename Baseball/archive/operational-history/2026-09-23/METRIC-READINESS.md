...
> Source: `Baseball/serving/METRIC-READINESS.md` at commit `48a3fa013d4c`. Earlier dates, pending work,
> runtime claims and commands below are historical; use the [current document](../../../serving/METRIC-READINESS.md)
...
[build reuse](../../../serving/BUILD-REUSE.md).

The remaining two latest-day run-construction-depth histories are covered by
the accepted [Q7 decision](../../design-records/mlb-game-zero-episode-history-isolation/README.md).
...
its separate immutable release. The [implementation guide](../../../serving/METRIC-SUITE-IMPLEMENTATION.md#required-serving-design)
...
See [implementation ownership](../../../serving/METRIC-SUITE-IMPLEMENTATION.md) and
[build reuse](../../../serving/BUILD-REUSE.md) for the engineering boundaries.
