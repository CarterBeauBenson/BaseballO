> Historical snapshot retained during the September 23, 2026 documentation cleanup.
> Source: `Baseball/sparql/metrics/README.md` at commit `48a3fa013d4c`.
> The pending checklists and refresh instructions below describe earlier work;
> use the [current query guide](../../../sparql/metrics/README.md) and
> [readiness record](../../../serving/METRIC-READINESS.md) for current decisions.
...
[accepted separately](../../design-records/mlb-game-batted-runner-resolution-containment/README.md)
and implemented as a bounded RML addition with source SHACL. The
[final award/origin decision](../../design-records/runner-award-origin-final-decision/README.md)
...
The [local proof evidence](../../design-records/runner-award-origin-final-decision/implementation.md)
establishes the admitted graph slices, not complete trajectory scoring. The
bounded [NiFi submission for game 566279](../../design-records/runner-award-origin-final-decision/nifi-proof-submission.json)
...
The subsequent [NiFi stage observation](../../design-records/runner-award-origin-final-decision/nifi-proof-observation.json)
...
metrics page. Its [live query proof](../../design-records/runner-award-origin-final-decision/metric-serving-evidence.json)
...
- [PAQ-2 defaults](../../../sparql/metrics/paq-2-release-defaults.json): 0–100 percentile display;
...
- [Inning-ending erosion](../../../sparql/metrics/tfs-inning-ending-policy.json): include evidenced
...
- [Error/FC exclusion](../../../sparql/metrics/contact-progress-policy.json): exclude that safe
...
[final origin policy](../../../sparql/metrics/trajectory-origin-policy.json) uses movement segment
...
[runner-location-evidence.rq](../../../sparql/metrics/runner-location-evidence.rq) inventories the
...
The [continuous-path terminal-out policy](../../../sparql/metrics/continuous-path-terminal-out-policy.json)
...
The [shared-play erosion convention](../../../sparql/metrics/shared-play-erosion-policy.json) is now
...
[runner-movement-evidence.rq](../../../sparql/metrics/runner-movement-evidence.rq) exposes individual
...
[attribution-evidence.rq](../../../sparql/metrics/attribution-evidence.rq) audits explicit resolution,
