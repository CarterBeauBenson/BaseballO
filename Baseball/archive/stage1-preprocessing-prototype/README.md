...
> **Historical prototype:** this workflow preprocesses and enriches the MLB JSON and is not part of the active direct-mapping architecture. It is retained for provenance only. See [`../../sources/mlb-game/mapping/`](../../sources/mlb-game/mapping/) for current work.
