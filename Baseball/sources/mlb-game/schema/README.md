# MLB game feed observed source contract
...
subset. The expanded 546-game corpus is additional coverage-discovery and
...
Before another provider is mapped, compare its fields against this inventory
and the active MLB mapping. Mark each field as an authoritative duplicate,
deterministically derivable, identity/join-only, genuinely additional, or
unresolved. This classification precedes Mermaid modeling and RML; the mere
presence of a column does not license a new class or triple.
