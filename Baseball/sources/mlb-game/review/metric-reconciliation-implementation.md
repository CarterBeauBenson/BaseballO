...
Implemented within the existing NiFi source lane, without changing RML,
ontology, semantic fingerprints or metric admission. The user requested
progress conditional on not requiring an RML mapping or ontology class.
No formal acceptance of E1 has been recorded.
...
## Next actual barriers under the mapping constraint
