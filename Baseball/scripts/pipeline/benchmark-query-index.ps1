...
$queryIndexAdmission = Resolve-QueryIndexManifestAdmission -Manifest $queryIndexManifest
...
$report = [ordered]@{
    ...
    queryIndexSemanticContractId = [string]$queryIndexAdmission.SemanticContractId
    queryIndexSemanticContractSha256 = [string]$queryIndexAdmission.SemanticContractSha256
    queryIndexImplementationSha256 = [string]$queryIndexAdmission.ImplementationSha256
    queryIndexAdmissionMode = [string]$queryIndexAdmission.Mode
...
$markdown.Add([string]::Format('- Query-index semantic contract: `{0}` (`{1}`)', [string]$queryIndexAdmission.SemanticContractId, [string]$queryIndexAdmission.SemanticContractSha256))
$markdown.Add([string]::Format('- Query-index implementation SHA-256 (provenance only): `{0}`', [string]$queryIndexAdmission.ImplementationSha256))
$markdown.Add('')
