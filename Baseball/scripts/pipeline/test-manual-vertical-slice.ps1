...
"@
$countResult = Invoke-RestMethod -Uri 'http://127.0.0.1:3031/baseball-dev/query' -Method Post -Body @{ query = $query } -Headers @{ Accept = 'application/sparql-results+json' }
...
"@
$result = Invoke-RestMethod -Uri 'http://127.0.0.1:3031/baseball-dev/query' -Method Post -Body @{ query = $typeQuery } -Headers @{ Accept = 'application/sparql-results+json' }
...
$emptyGamesResult = Invoke-RestMethod -Uri 'http://127.0.0.1:3031/baseball-dev/query' -Method Post -Body @{ query = $emptyGamesQuery } -Headers @{ Accept = 'application/sparql-results+json' }
