...
Run one of the seventeen measured query pairs through its reviewed automatic route:
...
`Auto` uses the fourteen evidence-backed indexed routes and keeps the three
