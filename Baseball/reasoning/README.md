...
Regenerate that baseline after an intentional ontology or reasoning-contract
change with:

```powershell
python Baseball/scripts/reasoning/generate-fixture-proof-baseline.py
```
...
| Complicated | `event-order` | 58 | 46 | 46/46 |
| Complicated | `event-structure` | 58 | 66 | 66/66 |
| Complicated | `participation` | 73 | 52 | 18/18 |
