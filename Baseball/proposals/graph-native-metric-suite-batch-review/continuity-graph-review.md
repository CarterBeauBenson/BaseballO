...
Status: **draft, requiring ontologist review**. The accepted
[verified-history criterion](../../archive/design-records/metric-suite-gap-answers-2026-09-09/continuity-decision.json)
...
[bounded excerpts](../mlb-game-batter-consequence-attribution/boundary-state-evidence.json).
