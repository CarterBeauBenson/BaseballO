...
All 122 triples maps are represented below as five functional families. Counts are derived from the current RML file.
...
flowchart LR
    ...
    SOURCE --> PLAY["Play hierarchy and results<br/>28 maps"]
    ...
    PLAY --> C2["Inning, half inning, plate appearance,<br/>batter act, time, generic and specific results"]
...
| Play hierarchy and results | 28 | canonical plays, batter acts, last play, eleven filtered result types |
