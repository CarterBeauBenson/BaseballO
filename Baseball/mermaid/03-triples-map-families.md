...
```mermaid
flowchart LR
    SOURCE["98 logical sources"] --> CONTEXT["game, team, venue, person, role, time, containment"]
...
The 345 Triples Maps are separated because each identity-bearing ontological
