...
```mermaid
flowchart LR
    SOURCE["87 logical sources"] --> CONTEXT["game, team, venue, person, role, time, containment"]
...
The 326 Triples Maps are separated because each identity-bearing ontological
