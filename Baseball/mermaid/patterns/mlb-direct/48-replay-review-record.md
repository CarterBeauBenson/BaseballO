...
| --- | --- | --- | --- |
| `ReplayReviewResultMap` | Baseball Replay Review Result ICE | identifier, is about, is output of, type | is about -> ReplayDecisionMap (template), is about -> ReviewOnFieldDecisionMap (template), is output of -> ChallengedReplayReviewActMap (template) |
