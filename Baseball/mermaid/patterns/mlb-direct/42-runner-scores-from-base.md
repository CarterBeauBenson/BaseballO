...
| `RunnerScoreBaseSource` | `game.json` | `$.liveData.plays.allPlays[*].runners[?(@.movement.isOut == false && @.movement.end == 'score' && @.movement.start == '1B' \|\| @.movement.isOut == false && @.movement.end == 'score' && @.movement.start == '2B' \|\| @.movement.isOut == false && @.movement.end == 'score' && @.movement.start == '3B')]` | 8 |
