...
| `SacrificeResultSource` | `game-context.json` | `$.liveData.plays.allPlays[?(@._baseballO.hasCompletedPlateAppearanceResult == true && (@.result.eventType == 'sac_fly' \|\| @.result.eventType == 'sac_bunt'))]` | 2 |
