...
| --- | --- | --- | ---: |
| `Result_walk_Source` | `game-context.json` | `$.liveData.plays.allPlays[?(@._baseballO.hasCompletedPlateAppearanceResult == true && (@.result.eventType == 'walk' \|\| @.result.eventType == 'intent_walk'))]` | 2 |
