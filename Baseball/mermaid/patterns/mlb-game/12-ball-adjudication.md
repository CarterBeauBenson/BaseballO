...
flowchart LR
    ...
    M05 -.->|has occurrent part; IRI reference| M06
    M06 -.->|has input; template| M10
    M06 -.->|has output; IRI reference| M07
    M06 -.->|occurrent part of; template| M01
    M06 -.->|precedes; template| M08
    M07 -.->|is about; template| M01
    M08 -.->|has input; IRI reference| M07
    M09 -.->|is about; IRI reference| M06
    M09 -.->|is about; IRI reference| M07
...
| `BallJudgmentMap` | Ball Judgment Act | has input, has output, occurrent part of, precedes | none |
