...
```mermaid
flowchart LR
    S01["Source: PitchClockSource"]
    S02["Source: PitchSource"]
...
| --- | --- | --- | ---: |
| `PitchClockSource` | `game-context.json` | `$.liveData.plays.allPlays[*].playEvents[?(@._baseballO.hasClockPair == true)]` | 2 |
| `PitchSource` | `game-context.json` | `$.liveData.plays.allPlays[*].playEvents[?(@.isPitch == true)]` | 5 |
