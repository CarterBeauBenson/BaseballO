...
# Foul-ball adjudication - MLB game RML
...
| --- | --- | --- | ---: |
| `AllFoulBallSource` | `game-context.json` | `$.liveData.plays.allPlays[*].playEvents[?(@.isPitch == true && @.details.call.code == 'F' \|\| @.isPitch == true && @.details.call.code == 'L')]` | 6 |
