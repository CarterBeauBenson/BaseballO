...
| `OutResultSource` | `game-context.json` | `$.liveData.plays.allPlays[?(@._baseballO.hasCompletedPlateAppearanceResult == true && (@.result.eventType == 'field_out' \|\| @.result.eventType == 'force_out' \|\| @.result.eventType == 'strikeout' \|\| @.result.eventType == 'double_play' \|\| @.result.eventType == 'grounded_into_double_play' \|\| @.result.eventType == 'triple_play'))]` | 2 |
...
| `Result_field_out_Source` | `game-context.json` | `$.liveData.plays.allPlays[?(@._baseballO.hasCompletedPlateAppearanceResult == true && (@.result.eventType == 'field_out' \|\| @.result.eventType == 'triple_play'))]` | 1 |
