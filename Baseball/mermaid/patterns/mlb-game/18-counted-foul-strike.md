...
| --- | --- | --- | ---: |
| `CountedFoulSource` | `game-context.json` | `$.liveData.plays.allPlays[*].playEvents[?(@.isPitch == true && @.details.call.code == 'F' && @.count.strikes == 1 \|\| @.isPitch == true && @._baseballO.isSecondCountedFoul == true)]` | 5 |
